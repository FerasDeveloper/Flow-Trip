...
Route::get('/tourism/getElementPackageById/{id}', [TourismCompanyController::class, 'getElementPackageById']);
...
Route::middleware('auth:sanctum')->group(function () {
  ...
  Route::prefix('vehicleowner')->group(function () {
    ...
    Route::get('/getAllViclyForuser', [VehiclyController::class, 'getAllViclyForuser']);
