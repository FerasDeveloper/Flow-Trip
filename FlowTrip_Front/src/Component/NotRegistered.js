...
const Card401 = () => {
  ...
  return (
    <StyledWrapper401>
      <div className="main_wrapper_401">
        <div className="main_401">
          <div className="antenna_401">
            <div className="antenna_shadow_401" />
            <div className="a1_401_401" />
            <div className="a1d_401" />
            <div className="a2_401" />
            <div className="a2d_401" />
            <div className="a_base_401" />
          </div>
          <div className="tv_401">
            <div className="cruve_401">
              <svg
                className="curve_svg_401"
                version="1.1"
        ...
        C86.34,11.918,137.664-5.445,189.928,1.502l-3.95,29.738C143.041,25.54,100.895,39.789,70.343,70.343z" />
            ...
            <div className="display_div_401">
              <div className="screen_out_401">
                <div className="screen_out1_401">
                  <div className="screen_401">
                    <span className="notfound_text_401"> NOT AUTHORIZED</span>
                  </div>
                  <div className="screenM_401">
                    <span className="notfound_text_401"> NOT AUTHORIZED</span>
                  </div>
                </div>
              </div>
            </div>
            <div className="lines_401">
              <div className="line1_401" />
              <div className="line2_401" />
              <div className="line3_401" />
            </div>
            <div className="buttons_div_401">
              <div className="b1_401"><div /></div>
              <div className="b2_401_401" />
              <div className="speakers_401">
                <div className="g1_401">
                  <div className="g11_401" />
                  <div className="g12_401" />
                  <div className="g13_401" />
                </div>
                <div className="g_401" />
                <div className="g_401" />
              </div>
          ...
          <div className="bottom_401">
            <div className="base1_401" />
            <div className="base2_401" />
            <div className="base3_401" />
          </div>
        </div>
        <div className="text_401">
          <div className="text_4011">4</div>
          <div className="text_4012">0</div>
          <div className="text_4013">1</div>
        </div>
        <div className="btn_wrapper_401">
          <button className="register_btn_401" onClick={() => navigate('/register')}>
            Go to Register
          </button>
        </div>
      </div>
...
const StyledWrapper401 = styled.div`
  /* نفس ستايلك الأصلي لكن غيرت الأسماء لأصناف 401 */
  .main_wrapper_401 {
    display: flex;
  ...
  .register_btn_401:hover {
    background-color: #d36604;
  }

  /* 🔽 هون انسخ باقي الكود تبعك وعدّل أسماء الكلاسات بإضافة _401 */
...
.screen_401:before, .screen_401:after {
  content: "";
  position: absolute;
  left: 0;
  z-index: 1;
